...
FATALRET2:
	...
	InvokeFn reset_msg_pointers	;AN000; reset critical & parse error messages
	MOV	AX,[PARENT]
...
getcomdsk3:
	...
	InvokeFn RPRINT			; Say command is invalid
getcomdsk4:
