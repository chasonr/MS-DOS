...
NOTEXISTS:
	InvokeFn BUILDDEST			; Find out all about the destination
	InvokeFn COMPNAME			; Source and dest. the same?
...
xa_set_error:					;AN030; error occurred on XA
	InvokeFn set_ext_error_msg		;AN030; get extended error
...
dest_open_okay: 				;AC030
	...
	InvokeFn set_file_code_page		;AN030; set the code page for the target
