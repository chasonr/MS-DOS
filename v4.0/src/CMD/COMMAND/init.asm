...
CONPROC:
	...
	InvokeFn sysdispmsg			;AN000; must be incorrect version
	mov	ax,es
...
NOCOMDRV:
	InvokeFn SETVECT 			; Set interrupt vectors 22h, 23h, & 24h
...
init_chk_delim:
	...
	InvokeFn itestkanj			;AN057; Is it DBCS?
...
Trans_Loaded:
	...
	InvokeFn CHKSUM				; Compute the checksum
	MOV	[SUM],DX			; Save it
...
MOVEMES:					;AN000;
	...
	InvokeFn SYSGETMSG			;AN000; get the offset of the char
