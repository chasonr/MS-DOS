...
path_search_ok:
	...
	push	ES
	InvokeFn find_path			; get a handle (ES:DI) on user path
	...
	InvokeFn search				; must do at least one search
...
;
	...
	trap	Current_dir
	InvokeFn DStrlen 			; Determine length of present info
...
;---------------
	...
	InvokeFn pathchrcmp			; a regular slash?
...
path_cr_l2:
	...
	InvokeFn search				; results are in AX & search_best_buf
