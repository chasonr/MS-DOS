...
;
	...
	InvokeFn get_ext_error_number		;AN022; get the error
...
assume	ds:resgroup				;AN022;
	...
	InvokeFn output_batch_name		;AN022; set up to print the error
	pop	ds				;AN022;
assume	ds:trangroup				;AN022;
	InvokeFn std_eprintf			;AN022; print out the error
...
;
	...
	InvokeFn PipeDel 			;AN004; turn off piping
...
FIRST_STRING:
	...
	InvokeFn DELIM				; is it a delimiter?
...
moredelim:
	...
	InvokeFn delim				; pathname -- have to do it ourselves
	...
	InvokeFn argv_calc			; convert arg index to pointer
...
Procedure   SkipDelim,NEAR
	...
	InvokeFn Delim				; check for ignoreable chars
...
;  strip off CALL from command line
	...
	InvokeFn scanoff 			;get to first non-delimeter
...
ASSUME	DS:RESGROUP
	TEST	[BATCH],-1
	jz	short ret_l_1			; If not in batch mode, a nop
	XOR	DX,DX
	PUSH	DS
	MOV	DS,Batch
...
GotByte:
	InvokeFn TESTKANJ			;AN000;  3/3/KK
...
SETERRDL:
	MOV	BX,DX
	InvokeFn get_ext_error_number		;AN022; get the extended error
