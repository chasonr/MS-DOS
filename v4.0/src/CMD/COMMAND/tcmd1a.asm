...
dirscan:
	xor	dx,dx				;AN000;
	InvokeFn parse_with_msg			;AC018; call parser
...
;
	...
	InvokeFn move_to_srcbuf			;AC000; move to srcbuf
...
set_dir_width:
	...
	InvokeFn setup_parse_error_msg		;AN018; set up an error message
...
;
	...
	InvokeFn pathcrunch			;AC000; set up FCB for dir
...
DoHeaderCont:
	...
	InvokeFn print_char			;AN051;   before DIR header
	InvokeFn build_dir_string		; get current dir string
	mov	dx,offset trangroup:Dirhead_ptr
	InvokeFn printf_crlf			; bang!
...
;
	...
	InvokeFn set_ext_error_msg		;AN022; yes - set up error message
	push	dx				;AN022; save message
	InvokeFn restudir			;AN022; restore user's dir
...
prbuf:
	...
	call	std_printf
	InvokeFn crlf2				;AC066;end the line
...
;
DirDone:
	InvokeFn get_ext_error_number		;AN022; get the extended error number
