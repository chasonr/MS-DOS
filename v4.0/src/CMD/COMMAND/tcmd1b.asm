...
crename_no_parse_error:
	...
	InvokeFn move_to_srcbuf			;AN000; move to srcbuf
...
;
	...
	InvokeFn parse_check_eol 		;AC000; are we at end of line?
...
notest3:
	...
	InvokeFn pathchrcmp			; Is the char in al a path sep?
...
typecont2:					;  will quit after this write.
	...
	dec	cx
	cmp	ax,cx
	jz	short ret_l_2			; One less byte OK (^Z)
...
Error_outputj:
	...
	int	int_command
	test	dl,devid_ISDEV
	jnz	short ret_l_2			; If device, no error message
	jmp	error_output
...
;
	...
	xor	dx,dx				;AC000;
	InvokeFn parse_check_eol 		;AC000; call parser
...
OKVOLARG:
	...
	InvokeFn print_char			;AN051;   before volume message
	push	ds
	pop	es
;
