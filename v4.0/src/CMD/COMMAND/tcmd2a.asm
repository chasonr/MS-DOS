...
print_prompt:
	...
	push	es
	InvokeFn find_prompt			; LOOK FOR PROMPT STRING
...
PATH:
	...
	InvokeFn PGetarg 			; Pre scan for arguments
...
path_eol:					;AN049; Parsing was clean
	...
	stosb					;AN049;    buffer
	InvokeFn find_path			;AN049; Find PATH in environment
	InvokeFn delete_path			;AC049; Delete any offending name
	InvokeFn scan_double_null		;AC049; Scan to end of environment
	InvokeFn move_name			;AC049; move in PATH=
...
store_path:					;AN049; Store the PATH in the environment
	...
	InvokeFn store_char			;AN049; no - store character
