...
DEVISOK:
	...
	InvokeFn Tsysgetmsg			;AN021; get the address of the message
...
getcp:
	...
	InvokeFn std_printf			;print it out
...
tn_doit:					;AN000;
	...
	InvokeFn Set_ext_error_msg		;AN000; get extended message
...
tn_print_xname: 				;AN000;
	...
	InvokeFn crlf2				;AN000; print a crlf
	InvokeFn printf_crlf			;AN000; print it out
...
parse_with_msg	Proc near			;AN018;
	...
	mov	[parse_last],si 		;AN018; save start of parameter
	InvokeFn cmd_parse			;AN018; call parser
