...
DATINIT PROC	FAR
	...
	MOV	ES,AX
	MOV	DS,AX
	InvokeFn TSYSLOADMSG			;AN000; preload messages
...
PRMTDAT:
	...
	InvokeFn GetDate 			;AN000; get date  for output
...
COMDAT:
	...
	xor	dx,dx				;AN029;
	InvokeFn cmd_parse			;AN029; call parser
...
DATERR:
	InvokeFn crlf2				;AN028; print out a blank line
...
TIMERR:
	...
	InvokeFn std_printf			; Print error message
