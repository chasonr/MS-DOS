...
eraerr:
	InvokeFn set_ext_error_msg		;AN022; set up the extended error
...
SLASHP_ERASE:					;AN000; entry point
	InvokeFn build_dir_string		;AN000; set up current directory string for output
...
delete_prompt_loop:				;AN000;
	...
	stosb					;AN000;     of DEST
	InvokeFn fcb_to_ascz			;AN000; convert filename from FCB to ASCIIZ string
...
Not_del_root:					;AN000;
	...
	InvokeFn scanoff 			;AN000; scan off leading delimiters
...
good_erase_exit:
	InvokeFn restudir			;AN000; we're finished - restore user's dir
	call	crlf2				;AN000; print out carriage return, line feed
	ret					;AN000; exit
...
PRINTVAL:
	...
	InvokeFn Tsysgetmsg			;AN000; get the address of the message
	...
	InvokeFn std_printf			;AC000; go print message
...
parse_on_off:					;AN032;    and start parsing
	...
	xor	dx,dx				;AN000;
	InvokeFn cmd_parse			;AC000; call parser
...
good_on_off:					;AN014;
	...
	mov	di,offset trangroup:parse_break ;AN000; Get adderss of PARSE_BREAK
	xor	dx,dx				;AN000;
	InvokeFn cmd_parse			;AN000; call parser
