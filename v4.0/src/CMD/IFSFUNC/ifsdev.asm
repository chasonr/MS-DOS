...
ifs_980_l_2:
	JMP	SHORT ifs_980_l_1			;   go return in ifsutil	 ;AC007;
											 ;AN000;
PGS_10: 										 ;AN000;
	RestoreReg <AX> 				; restore input al		 ;AN007;
	InvokeFn SET_DEPIOCTL_IFSR			; prep IFSRH			 ;AN000;
...
ASSUME	DS:IFSSEG									 ;AN000;
											 ;AN000;
	InvokeFn SET_THISIFS_UNC 			; set thisifs to unc		 ;AN000;
											 ;AN000;
	InvokeFn CALL_IFS				; call ifs driver w/request	 ;AN000;
											 ;AN000;
	JNC	PGS_120 								 ;AN000;
	ADD	SP,2					; clean stack of ax (fcn #)	 ;AN013;
	JMP	SHORT ifs_980_l_2			;  go ret on error		 ;AN000;
											 ;AN000;
PGS_120:										 ;AN000;
	POP	AX					; restore original input fcn	 ;AN000;;AM013;
	InvokeFn DF_TO_DFL				; Update dfl entry		 ;AN000;
											 ;AN000;
...
ifs_990_l_2:
	JMP	SHORT ifs_990_l_1			; go return with no carry	 ;AN000;
											 ;AN000;
PGS_160:										 ;AN000;
	MOV	CX,ES:[BX.IFSR_BUFSIZE] 						 ;AN000;
	CallInstall Get_User_Stack,multDOS,24						 ;AN000;
	MOV	[SI].User_CX,CX 	; Size of pre string just transferred		 ;AN000;
	JMP	SHORT ifs_990_l_2			; go return with no carry	 ;AN000;
											 ;AN000;
...
IDC_120:					; ifs: get parms			 ;AN000;
	InvokeFn PREP_IFSR			; clear ifsr				 ;AN003;
	...
	InvokeFn SET_CATEGORY			; this has nothing to do w/catrgory	 ;AN000;
...
IDC_200:										 ;AN000;
	...
	ADD	SI,2				;     | 				 ;AN003;
	InvokeFn CONVERT_NAME_ASCIIZ		;     | mov name string over		 ;AN003;
...
ASSUME	DS:NOTHING,ES:NOTHING								 ;AN000;
	...
	InvokeFn PREP_IFSR			;  &  ifsr				 ;AM011;
	InvokeFn SFT_TO_SFF			; sets [THISIFS]			 ;AN000;
						;      ES:BX -> IFSRH			 ;AN000;
						;      IFSR_OPEN_CB@			 ;AN000;
						;      IFSR_DEVICE_CB@			 ;AN000;
						;      ds - IFSSEG			 ;AN000;
...
ifs_990_l_4:
	JMP	ifs_990				;  go ret no carry			 ;AN000;
											 ;AN000;
...
IDO_30: 										 ;AN000;
	...
	JNZ	IDO_35									 ;AN009;
ifs_990_l_5:
	JMP	SHORT ifs_990_l_4		;   no dfl - just go successfully	 ;AN009;
IDO_35:
	XOR	CH,CH									 ;AN000;
...
IDO_60: 										 ;AN000;
	...
	InvokeFn CALL_IFS			; call ifs with device oper request	 ;AN000;
	RestoreReg <CX> 			; restore count 			 ;AN000;
											 ;AN000;
IDO_100:										 ;AN000;
	ADD	SI,DX				; prep for next dfl			 ;AN000;
	LOOP	IDO_40				; go process next dfl			 ;AN000;
	JMP	SHORT ifs_990_l_5		; Finished.  Go ret no carry.		 ;AN000;
											 ;AN000;
											 ;AN000;
...
;;;aliastransfer ifs_980			; lpt1 is alias, assume no echo 	 ;AN000;
											 ;AN000;
ISEC_15:										 ;AN000;
	InvokeFn PREP_IFSR			; zero out ifsr 			 ;AN000;
	InvokeFn DFL_TO_DF			; DFL: sets [THISIFS]			 ;AN000;
						;	    ES:BX -> IFSRH		 ;AN000;
						;	    IFSR_DEVICE_CB@		 ;AN000;
						;	    ds - IFSSEG 		 ;AN000;
...
IDI_17: 					; (welcome lock)			 ;AN006;
	...
	InvokeFn CDS_TO_CD			; CDS: sets [THISIFS]			 ;AN000;
						;      IFSR_DEVICE_CB@			 ;AN000;
						;      ds - netwrk			 ;AN000;
	CMP	AL,QUERY_OS_TYPE							 ;AN000;
	JNE	IDI_40									 ;AN000;
...
IDI_30: 										 ;AN006;
	InvokeFn SFT_TO_SFF			; sets: [THISIFS]			 ;AN000;
						...
						;	ds - netwrk			 ;AN000;
IDI_40: 										 ;AN000;
	InvokeFn SET_CATEGORY			; set category 1-unc 0-other		 ;AN000;
	MOV	ES:[BX.IFSR_CATEGORY],CL						 ;AN000;
IDI_60:
	MOV	DX,IFSIOCTL			; check if fs supports fs ioctl
	InvokeFn CHECK_IFS_ATTRIBUTE
...
IDI_100:										 ;AN000;
	MOV	AX,error_invalid_function						 ;AN000;
IDI_120:										 ;AN006;
	InvokeFn SET_EXTERR_INFO 		; set error info			 ;AN006;
ifs_980_l_4:
	JMP	ifs_980				; go to general error return		 ;AN000;
											 ;AN000;
