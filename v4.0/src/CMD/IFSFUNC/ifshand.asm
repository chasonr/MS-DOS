...
C_20:						; (welcome ifs_close)			 ;AN000;
	InvokeFn DRIVE_FROM_SFT			; set IFSDRV for possible criter	 ;AN000;
...
C_40:											 ;AN000;
	MOV	ES:[BX.IFSR_FUNC],AL							 ;AN000;
											 ;AN000;
	InvokeFn CALL_IFS			; *** call fs with close request	 ;AN000;
											 ;AN000;
	JNC	C_60									 ;AN000;
...
ASSUME	DS:DOSGROUP				;					 ;AN020;
	...
	MOV	WORD PTR ES:[BX.IFSR_POSITION+2],CX					 ;AN000;
											 ;AN000;
	InvokeFn CALL_IFS			; call fs with lseek request		 ;AN000;
											 ;AN000;
	JC	LS_1000 								 ;AN000;
...
R_20:						; (welcome lock/read)			 ;AN000;
	...
	InvokeFn PREP_IFSR			; zero out ifsr, es:bx -> ifsr		 ;AN000;
...
W_80:						; (welcome read)			 ;AN010;
	...
	InvokeFn SFT_TO_SFF			; sets: [THISIFS]			 ;AN000;
						...
						;	ds - IFSSEG			 ;AN000;
											 ;AN000;
	InvokeFn CALL_IFS			; *** call fs with read/write request	 ;AN000;
											 ;AN000;
	JNC	W_100									 ;AN000;
...
L_60:											 ;AN000;
	...
	MOV	WORD PTR [THISSFT+2],ES 						 ;AN000;
	InvokeFn DRIVE_FROM_SFT			; set IFSDRV for possible criter	 ;AN000;
	InvokeFn PREP_IFSR			; clear ifsrh				 ;AM003;
	MOV	CS:DEVICE_CB@_OFFSET,IFSR_DEVICE_CB@					 ;AN000;
	InvokeFn SFT_TO_SFF			; sets: [THISIFS]			 ;AN000;
						;	ES:BX -> IFSRH			 ;AN000;
						;	IFSR_OPEN_CB@			 ;AN000;
...
;;;;;;;;MOV	WORD PTR ES:[BX.IFSR_RANGE@+2],DS					 ;AD010;
	...
	InvokeFn CALL_IFS			; *** call fs with lock request 	 ;AN000;
											 ;AN000;
	JNC	L_100									 ;AN000;
	JMP     SHORT ifs_1000_l_1		; go to general return	 (util) 	 ;AN000;
L_100:											 ;AN000;
	InvokeFn SFF_TO_SFT								 ;AN000;
	JMP     SHORT ifs_990_l_1		; go to general good ret (util) 	 ;AN000;
											 ;AN000;
											 ;AN000;
...
;						;	ds - IFSSEG			 ;AN000;
;************************************************
;	InvokeFn CALL_IFS			; *** call fs with fileattr request	 ;AN000;
;************************************************
;	JNC	XFA_100 								 ;AN000;
;	JMP	C_1000									 ;AN000;
;FA_100:										 ;AN000;
