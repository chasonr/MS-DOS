...
;											 ;AN000;
	...
	INT	21H									 ;AN000;
	call	IFSFINIT			; Do general INIT			 ;AN000;
											 ;AN000;
	XOR	BX,BX									 ;AN000;
...
;											 ;AN000;
	...
	INT	2FH									 ;AN000;
ASSUME	DS:DOSGROUP									 ;AN000;
	InvokeFn SERVER_IFSFUNC_DATA_AREA						 ;AN000;
	POP	DS									 ;AN000;
	InvokeFn SET_IFS_DOSCALL@							 ;AN003;
											 ;AN000;
	PUSH	CS									 ;AN000;
	POP	ES									 ;AN000;
;											 ;AN007;
...
ASSUME	DS:NOTHING									 ;AN000;
	...
	SaveReg <DS,SI> 			; dummy cds ptr 			 ;AN000;
											 ;AN000;
	InvokeFn PREP_IFSR			; sets es:bx -> ifsr, 0s fields,	 ;AN000;
						; ds - ifsseg				 ;AN000;
	MOV	DEVICE_CB@_OFFSET,IFSR_DEVICE_CB@					 ;AN000;
	InvokeFn CDS_TO_CD			; sets ifsr_device_cb@			 ;AN000;
...
AA_40:						; ** Loop here on ifs drivers		 ;AN000;
	InvokeFn CALL_IFS			; call ifs driver w/attach start req	 ;AN000;
											 ;AN000;
	JC	AA_60				; jmp on no click			 ;AN000;
						; click:				 ;AN000;
	RestoreReg <DI,ES>			; restore cds ptr to es:di		 ;AN000;
	InvokeFn CD_TO_CDS			; update cds entry			 ;AN000;
...
;; D526   CallInstall SHAREInstall,multSHARE,0	  ;   check that share loaded		   ;AN000;
	...
	CMP	AL,INSTALLED and 0FFh		;   if not generate warning		 ;AN000;
	JE	AA_50									 ;AN000;
