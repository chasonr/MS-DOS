...
ifs_980_loc_2:
	JMP	SHORT ifs_980_loc_1	; go to general bad ret in util 		 ;AN000;
											 ;AN000;
											 ;AN000;
...
ifs_990_loc_2:
	JMP	SHORT ifs_990_loc_1	; go to general good ret in util		 ;AN000;
											 ;AN000;
SAM_20: 				; print off - pause				 ;AN000;
	CALL	PrintOff								 ;AN000;
ifs_990_loc_3:
	JMP	SHORT ifs_990_loc_2	; go to general good ret in util		 ;AN000;
											 ;AN000;
SAM_40: 				; Drive 					 ;AN000;
	CMP	BL,4									 ;AN000;
	JNZ	SAM_80			; jump on parm error				 ;AN000;
...
ifs_990_loc_4:
	JMP	SHORT ifs_990_loc_3	; go to general good ret in util		 ;AN000;
											 ;AN000;
SAM_60: 				; drive off					 ;AN000;
	CALL	AssignOff		; turn drives off (pause)			 ;AN000;
	JMP	SHORT ifs_990_loc_4	; go to general good ret in util		 ;AN000;
											 ;AN000;
											 ;AN000;
SAM_80: 										 ;AN000;
	MOV	AX,error_invalid_parameter						 ;AN000;
	InvokeFn SET_EXTERR_INFO 							 ;AN000;
	JMP	SHORT ifs_980_loc_2	; go to general bad ret in util 		 ;AN000;
											 ;AN000;
											 ;AN000;
...
GII_160:										 ;AC003;
	...
	InvokeFn PREP_IFSR			; init ifsr				 ;AC003;
											 ;AC003;
	MOV	DEVICE_CB@_OFFSET,IFSR_DEVICE_CB@					 ;AC003;
	InvokeFn CDS_TO_CD			; CDS: sets [THISIFS]			 ;AC003;
						;	    ES:BX -> IFSRH		 ;AC003;
...
GII_200:										 ;AC003;
	PUSH	AX				; push type back (BX)			 ;AC003;
											 ;AC003;
;***********************************************************************************************
	InvokeFn CALL_IFS			; call fs with attach status request	 ;AC003;
;***********************************************************************************************
											 ;AC003;
	JNC	GII_220 								 ;AC003;
...
GII_560:										 ;AC003;
	...
	InvokeFn PREP_IFSR			; init ifsr				 ;AC003;
	InvokeFn DFL_TO_DF			; DFL: sets [THISIFS]			 ;AC003;
						;	    ES:BX -> IFSRH		 ;AC003;
						;	    IFSR_DEVICE_CB@		 ;AC003;
						;	    ds - IFSSEG 		 ;AC003;
	MOV	ES:[BX.IFSR_LENGTH],LENGTH_ATTSTAT					 ;AC003;
...
ifs_1000_loc_2:
	JMP	ifs_1000			; go to general ret in util		 ;AC003;
											 ;AC003;
GII_620:										 ;AC003;
	RestoreReg <AX,DI>			; device type, target offset		 ;AC003;
	TEST	IFSPROC_FLAGS,Filesys_Status						 ;AC003;
...
GII_630:										 ;AN022;
	...
	MOV	ES,DX				; target				 ;AC003;
;;;;;;;;MOV	BX,AX									 ;AC003;;AD022;
	JMP	SHORT ifs_1000_loc_2							 ;AC003;
											 ;AC003;
...
AS_20:						; IFS device/drive			 ;AN000;
	...
	CALL	FIND_IFS_DRIVER 		; sets [THISIFS]			 ;AN000;
	JC	AS_25									 ;AN000;
	SaveReg <CX>				; save cx since next destroys		 ;AN000;
	InvokeFn SET_CATEGORY			; do this to determine unc or not	 ;AN000;
...
ASSUME	DS:IFSSEG									 ;AN000;
	InvokeFn SET_EXTERR_INFO 							 ;AN000;
ifs_980_loc_5:
	JMP	SHORT ifs_980_loc_4							 ;AN000;
											 ;AN000;
AS_40:											 ;AN000;
	InvokeFn SET_THISIFS_UNC 							 ;AN000;
	SaveReg <CX>									 ;AN004;;AC015;
	InvokeFn NET_TRANS								 ;AN000;
...
ifs_980_loc_7:
	JMP	SHORT ifs_980_loc_6		; go return with carry			 ;AN000;
											 ;AN000;
AS_100: 										 ;AN000;
	...
	InvokeFn PREP_IFSR			; clear ifsrh				 ;AN000;
	InvokeFn CDS_TO_CD			; CDS: sets ES:BX -> IFSRH		 ;AN000;
...
AS_200: 					; DEVICE ATTACH:			 ;AN000;
	InvokeFn DFL_MATCH			; check if device already assigned	 ;AN000;
	JC	AS_220				; cf-0 match, cf-set no match		 ;AN000;
	MOV	AX,error_already_assigned						 ;AN000;
ifs_980_loc_8:
	JMP	SHORT ifs_980_loc_7		; go return with carry			 ;AN000;
											 ;AN000;
AS_220: 										 ;AN000;
	SaveReg <ES,DI,BX>			; save target parm ptr & type		 ;AN000;
	InvokeFn CREATE_DFL_ENTRY		; DFL: sets ES:BX -> IFSRH		 ;AN000;
						;	    IFSR_DEVICE_CB@		 ;AN000;
						;	    ds - IFSSEG 		 ;AN000;
	JNC	AS_240									 ;AN000;
	RestoreReg <BX,DI,ES>			; restore stack 			 ;AC019;
	InvokeFn CONSIST_SFT								 ;AN000;
ifs_980_loc_9:
	JMP	SHORT ifs_980_loc_8		;  error ret				 ;AC019;
AS_240: 										 ;AN000;
...
ifs_990_loc_8:
	JMP	ifs_990									 ;AN000;
											 ;AN000;
AS_460: 										 ;AN000;
	InvokeFn DF_TO_DFL								 ;AN000;
	InvokeFn CONSIST_SFT								 ;AN025;
	JMP	SHORT ifs_990_loc_8							 ;AN000;
											 ;AN000;
											 ;AN000;
...
ASSUME	DS:IFSSEG									 ;AN000;
	InvokeFn SET_EXTERR_INFO 							 ;AN000;
ifs_980_loc_12:
	JMP	SHORT ifs_980_loc_11							 ;AN000;
AE_20:											 ;AN000;
...
ifs_980_loc_13:
	JMP	SHORT ifs_980_loc_12							 ;AN000;
AE_60:											 ;AN000;
	PUSH	AX				; drive #				 ;AN000;
	PUSH	ES									 ;AN000;
	POP	DS									 ;AN000;
	MOV	SI,DI				; move cds ptr to ds:si 		 ;AN000;
	InvokeFn CDS_TO_CD								 ;AN000;
	OR	IFSPROC_FLAGS,ISCDS							 ;AN000;
...
AE_210: 										 ;AN000;
	...
	JMP	SHORT ifs_1000_loc_5							 ;AN000;
AE_220: 										 ;AN000;
...
;	???????????? check with baf on what reverting to ...				 ;AN000;
											 ;AN000;
	InvokeFn DFL_TO_DF			; DFL: sets [THISIFS]			 ;AN000;
						;	    ES:BX -> IFSRH		 ;AN000;
						;	    IFSR_DEVICE_CB@		 ;AN000;
						;	    ds - IFSSEG 		 ;AN000;
	JMP	SHORT AE_400								 ;AN000;
...
AE_405: 										 ;AN000;
	JMP	SHORT ifs_980_loc_13							 ;AN000;
AE_410: 										 ;AN000;
...
AE_420: 										 ;AN000;
	...
	CALL	DELETE_DFL_ENTRY							 ;AN000;
AE_440: 										 ;AN018;
	JMP	SHORT ifs_990_loc_10							 ;AN000;
											 ;AN000;
											 ;AN000;
...
IA_20:					; Loop through sftfcb's                          ;AN000;
	...
	PUSH	CX									 ;AN000;
IA_40:					; CLOSE 					 ;AN000;
	InvokeFn IFS_CLOSE		; IGNORE ANY ERRORS ON THIS.			 ;AN000;
...
IA_80:											 ;AN000;
	...
	InvokeFn PREP_IFSR			; sets esbx -> ifsrh			 ;AN000;
...
GIDN_40:										 ;AN000;
	InvokeFn MOVE_DRIVER_NAME		; move ifs driver name into buffer	 ;AN000;
											 ;AN000;
...
ASSUME	ES:IFSSEG									 ;AN000;
	...
	InvokeFn MOVE_DRIVER_NAME		; strcmp				 ;AN000;
...
;***********************************************************************************************
	InvokeFn CALL_IFS			; call ifs driver w/request		 ;AN000;
;***********************************************************************************************
...
ASSUME	DS:IFSSEG									 ;AC003;
											 ;AC003;
	InvokeFn SET_DEPIOCTL_IFSR		; prep IFSRH				 ;AC003;
	InvokeFn SET_THISIFS_UNC 		; prep IFSRH				 ;AC003;
...
;***********************************************************************************************
	InvokeFn CALL_IFS			; call redir w/get unc item request	 ;AC003;
;***********************************************************************************************
...
GUI_20: 				; new style					 ;AC003;
	...
	SaveReg <DI>									 ;AC003;
	MOV	DI,ES:[DI]								 ;AC003;
	InvokeFn GET_UNC_FS_NAME 							 ;AC003;
	RestoreReg <DI> 								 ;AC003;
	SaveReg <AX,DI> 								 ;AC003;
	INC	DI									 ;AC003;
	INC	DI									 ;AC003;
