...
IFB_20: 										 ;AN000;
	...
	CALL	PREP_IFSR			; sets es:bx -> ifsr (zeroed out)	 ;AN000;
...
ASSUME	DS:NOTHING,ES:NOTHING								 ;AN000;
	...
	CALL	PREP_IFSR			; sets es:bx -> ifsr (zeroed out)	 ;AN000;
	Context DS									 ;AN000;
	CALL	SFT_TO_SFF			; SFT: sets [THISIFS]			 ;AN000;
						;	    ES:BX -> IFSRH		 ;AN000;
						;	    IFSR_CB@			 ;AN000;
						;	    ds - IFSSEG 		 ;AN000;
...
;************************************************************************************	 ;AN000;
	...
	JNZ	CI_05									 ;AN000;
	InvokeFn EcritIFS			; enter ifs critical section		 ;AN000;
	JMP	SHORT CI_10								 ;AN000;
CI_05:											 ;AN000;
	InvokeFn EcritNET			; enter network critical section	 ;AN000;
...
;----------------------------------------------------------------------------		 ;AN000;
	...
	InvokeFn LcritIFS			; leave ifs critical section		 ;AN000;
	JMP	SHORT CI_17								 ;AN000;
CI_15:											 ;AN000;
	InvokeFn LcritNET			; leave network critical section	 ;AN000;
...
NoTrans:										 ;AN029;
	POP	DS
	InvokeFn SET_EXTERR_INFO 		; yes - set error info			 ;AN000;
...
CI_26:											 ;AN029;
	...
	InvokeFn IFS_I24 			;	do int 24h			 ;AN000;
...
CI_37:											 ;AN011;
	...
	InvokeFn DEVICE2EXTERR			; convert device - ext error		 ;AN011;
...
CI_38:											 ;AN011;
	...
	InvokeFn PHONEY_DPB			;     Set phoney NET DPB for INT 24	 ;AN000;
...
CDE_140:										 ;AN000;
	CALL	PREP_IFSR			; init req hdr				 ;AN000;
	CALL	DFL_TO_DF								 ;AN000;
	JMP	ifs_990 								 ;AN000;
											 ;AN000;
...
;;;;;;;;MOV	AH,BYTE PTR [SI.SF_ATTR_HI]	; sff_attr_hi  - no longer exists	 ;AD024;
	...
	RestoreReg <SI> 								 ;AN016;
											 ;AN000;
	ADD	DI,SFF_FSDA-SFF_RESV     	; sff_fsda  1st word			 ;AN000;
...
;;;;;;;;MOV	BYTE PTR ES:[DI.SF_ATTR_HI],AH	;    no longer exists			 ;AD024;
	...
	REP	MOVSB									 ;AN000;
											 ;AN000;
	ADD	SI,SFF_FSDA-SFF_RESV     	; sft_fsda  1st word			 ;AN000;
...
ASSUME	DS:IFSSEG,ES:IFSSEG								 ;AN000;
	...
	POP	DI									 ;AN000;
											 ;AN000;
	ADD	SI,CD_FSDA-CD_RESV      	; curdir_id				 ;AN000;
	LODSW										 ;AN000;
