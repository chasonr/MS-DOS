...
void   initbuf(DWORD *);
void   init_control_buf(unsigned int   *);
void   usererror(WORD );
...
void   dorestore(BYTE ,BYTE ,BYTE *,BYTE *,BYTE *,struct timedate *);
void   check_bkdisk_old(struct disk_header_old *,    struct disk_info *,BYTE,unsigned int *);
void   check_bkdisk_new(struct disk_header_new far *,struct disk_info *,BYTE,unsigned int *);
void   print_info(int ,int ,int);
WORD   pathmatch(BYTE *,BYTE *);
WORD   switchmatch(struct file_info *,BYTE,struct timedate *);

int    check_flheader_old(struct file_info *,unsigned char *,unsigned int ,
			  unsigned int ,unsigned int ,unsigned long ,unsigned char ,
...
void   restore_a_file(struct file_info *,struct disk_info *,unsigned long,
	struct disk_header_old *,struct disk_header_new far *,unsigned char,unsigned char,
...
extern void __cdecl sysloadmsg(union REGS *, union REGS *);   /*_msgret *//*;AN000;6 */
extern void __cdecl sysdispmsg(union REGS *, union REGS *);   /*_msgret *//*;AN000;6 */
extern void __cdecl parse	  (union REGS *, union REGS *);   /* _parse *//*;AN000;4 */
