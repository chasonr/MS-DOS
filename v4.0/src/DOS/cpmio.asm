...
StdCILop:							  ;AN000;
	InvokeFn INTER_CON_INPUT_NO_ECHO 			  ;AN000;
...
;;;;		 to shorten loop in consideration of the PC Convertible
	...
	JZ	check_ok
	InvokeFn DOSINIT 		; should never come here
check_ok:
	POP	BX
...
STRING_OUT1:
	LODSB
 IF  DBCS				;AN000;
	InvokeFn TESTKANJ		;AN000; 	      2/11/KK		 ;AN000;
	jz	SBCS00			;AN000; 	      2/11/KK		 ;AN000;
	InvokeFn OUTT			;AN000; 	      2/11/KK		 ;AN000;
...
RESFLG:
 ...
 IF  DBCS				;AN000;
	XOR	AH,AH			;AN000;
	InvokeFn IOFUNC			;AN000; get the character
...
ROLP:
	...
	InvokeFn DSKSTATCHK		     ;AN002; check control break
RAWOSTRT:
	MOV	AH,3
	InvokeFn IOFUNC
	JZ	ROLP
