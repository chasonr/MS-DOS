...
NORMCH:
	...
	InvokeFn OUTT		; Transmit linefeed
...
GETBUF:
	...
	InvokeFn $STD_CON_STRING_INPUT		; Get input buffer
	POP	DI
	POP	ES
	POP	CX
...
ASSUME	DS:NOTHING
	...
	InvokeFn DEVIOCALL		; DS:SI -> DEVICE
...
SKPCLLP:
	...
	jc	short ret_l_1
	XCHG	BX,DI
	InvokeFn IsEOF			; test for eof based on fat size
	JAE	HAVESKIPPED
	LOOP	SKPCLLP
HAVESKIPPED:
	MOV	[NXTCLUSNUM],BX
...
ASSUME	DS:NOTHING,ES:NOTHING		       ;AN000;
	...
	InvokeFn SET_ACC_ERR_DS		       ;AN000;;MS.
	return				;AN000;;MS.
write_cont:				;AN000;
...
Not_Truncate:				;AN000;
	...
	InvokeFn LOCK_CHECK		;AN000;;MS. check lock
	POP	CX			;AN000;;MS. restore reg
	JNC	WRITE_OK		;AN000;;MS. lock ok
	InvokeFn WRITE_LOCK_VIOLATION	;AN000;;MS. issue I24
...
ASSUME	DS:NOTHING,ES:NOTHING		       ;AN000;
	...
	InvokeFn SET_ACC_ERR		       ;AN000;;MS.
	return				       ;AN000;;MS.
do_retry:				;AN000;
	MOV	AL,0			;AN000;;MS. check read access
	InvokeFn LOCK_CHECK		;AN000;;MS. check lock
	JNC	READ_OK 		;AN000;;MS. lock ok
	InvokeFn READ_LOCK_VIOLATION	;AN000;;MS. issue I24
