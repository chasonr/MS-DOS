...
;	AX has error code
	...
	InvokeFn CHECK_WRITE_LOCK	  ;IFS. check write lock		 ;AN000;
...
;;; 11/5/86 FastSeek
	...
	InvokeFn FastSeek_Truncate     ;FS.					;AN000;
NULL_FILE:
;;; 11/5/86 FastSeek
	InvokeFn ALLOCATE
	POP	AX
...
NEXTBUFF:			; Search for buffers
	...
	InvokeFn INVALIDATE_SC		    ;LB. invalidate SC			;AN000;
...
inrange2:
	...
	InvokeFn DEC_DIRTY_COUNT 	    ;LB. then decrement dirty count	;AN000;
not_dirty:
...
KILLFIL:
	...
	POP	ES
;; 11/5/86 FastSeek
	InvokeFn Delete_FSeek   ; delete fastseek entry
...
;; 10/23/86 FastOpen update
	...
	InvokeFn FastOpen_Update 	 ; call fastopen
	POP	DX
	POP	CX
	POP	AX
	POP	BP
...
doi24:
	...
	InvokeFn NET_I24_ENTRY			;MS. issue I24			;AN000;
