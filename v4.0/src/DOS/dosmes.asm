...
extrn	intCNE0:near			;AN000; 2/17/KK
 ...
 ELSE					;AN000;
	InvokeFn $std_con_input_no_echo	; Get the second byte of the sequence
 ENDIF					;AN000;
	IF Rainbow eq 0
...
EatParm:
	InvokeFn $std_con_input_no_echo	; get argument
...
EatNum:
	InvokeFn $std_con_input_no_echo	; get next digit
InDigit:
...
EatAlpha:
	...
	JMP	GoGetCh
EatPQRS:
	InvokeFn $std_con_input_no_echo	; eat char after O
	JMP	GoGetCh
	ENDIF
