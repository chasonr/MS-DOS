...
include bugtyp.asm
	...
	EXTERN SYS_Ret_OK:NEAR, SYS_Ret_Err:NEAR
...
ENDIF					;AN000;
	EnterCrit   critSFT
	InvokeFn SFNFree 		; get a free sfn
	LeaveCrit   critSFT
...
;
	InvokeFn JFNFree 		; get a free jfn
	JNC	SaveJFN
OpenFailJ:
...
;
	...
	InvokeFn TransPath		; convert the path
...
;
	...
	InvokeFn TransPathSet		; get correct path
...
;
	...
	InvokeFn TransPathSet		; go get normalized path
	RestoreReg <CX>
	...
	call	SetAttrib
	InvokeFn DOS_Delete		; remove that file
...
;	       = error_access_denied
	...
	InvokeFn TransPathSet		; munge the paths
...
rnloop: 				   ;AN000;
	InvokeFn GetCDSFromDrv		   ;AN000;;MS.
	JC	dorn			   ;AN000;;MS.	end of CDS
	InvokeFn StrCmp			   ;AN000;;MS.	current dir ?
...
dorn:					   ;AN000;
	...
	call	SetAttrib
	InvokeFn DOS_Rename		; do the deed
	JC	UnlinkE 		; errors
...
okok:					;AN000;
 ...
 ENDIF					;AN000;
	...
	InvokeFn PathChrCmp		; Is it a path separator?
	JZ	SETENDPTR		; Yes
STOREPTH:
	MOV	AL,'\'
...
goopen: 					 ;AN000;
	...
	InvokeFn $CreateNewFile			 ;AN000;;EO.  yes
...
chknext:
	...
	InvokeFn $Creat				 ;AN000;;EO.  must be replace open
...
noserver:
	InvokeFn $Open2				 ;AN000;;EO.  do open
	JNC	ext_ok				 ;AN000;;EO.
...
do_creat:
	...
	MOV	DX,SI				 ;AN000;;EO.
	InvokeFn $Creat				 ;AN000;;EO.  do create
...
;	InvokeFn $File_times		;AN000;;EO.
;nosetea:				;AN000; EO
;	POP	DX			;AN000;;EO. restore file name addr
;	POP	DS			;AN000;;EO.
;	JC	extexit2		;AN000;;EO.
	InvokeFn get_user_stack		;AN000;;EO.
...
extexit2:				;AN000; ERROR RECOVERY
	...
	InvokeFn $UNLINK 		;AN000;EO. delete the file
	JMP	SHORT reserror		;AN000;EO.

justopen:				;AN000;
	InvokeFn $close			;AN000;EO. pretend never happend
reserror:				;AN000;
