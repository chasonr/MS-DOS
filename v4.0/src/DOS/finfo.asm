...
;	InvokeFn IFS_SEARCH_FIRST	       ;IFS. do search first		;AN000;
;	JC	nofiles 		       ;IFS. file not existing		;AN000;
delete_next_file:			       ;IFS.				;AN000;
;	InvokeFn IFS_REN_DEL_CHECK	       ;IFS. do REN_DEL_CHECK		;AN000;
...
LOCAL_SET:
	...
	MOV	[NoSetDir],1		; if we find a dir, don't change to it
	InvokeFn GetPath 		; get path through fastopen if there	 ;AC000;
