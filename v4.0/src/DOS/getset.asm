...
.list
	...
	extern SYS_RET_OK:NEAR,SYS_RET_ERR:NEAR,From_GetSet:NEAR
...
international_get:
	...
	jz	short ret_l_1		 ; return if equal
	MOV	DX,BX
...
capit:					;AN000;
	...
	InvokeFn GETLET3 		;AN000;;MS. upper case it
	InvokeFn get_user_stack		;AN000;;MS. get user stack
...
IF  DBCS				;AN000;
	PUSH	AX			;AN000;;MS.
	MOV	AL,DL			;AN000;;MS.
	InvokeFn TESTKANJ		;AN000;;MS. DBCS ?
	POP	AX			;AN000;;MS.
...
nono:					;AN000;
ok_ret_2:
	JMP	short ok_ret_1		;AN000;;MS. done
capstring:				;AN000;
...
GETDONE:
	InvokeFn get_user_stack		; return actual length to user's CX
	MOV	[SI.user_CX],CX
ok_ret_3:
	JMP	short ok_ret_2
setsize:
...
NLSERROR:
err_ret_5:
	JMP	SHORT err_ret_4		; return what is got from NLSFUNC
...
;	AL = Number of drives, NO ERROR RETURN IF DRIVE NUMBER BAD
	...
	MOV	AL,DL
	INC	AL			; A=1, b=2...
	InvokeFn GetVisDrv		; see if visible drive
...
set_interim:				; Set interim console flag		;AN000;
	...
	pop	dx								;AN000;
ok_ret_7:
	JMP	short ok_ret_6							;AN000;

get_interim:									;AN000;
	push	dx								;AN000;
	push	ds								;AN000;
	mov	dl,[InterCon]							;AN000;
	InvokeFn get_user_stack		; get interim console flag		;AN000;
 assume ds:nothing								;AN000;
	mov	[SI.user_DX],DX 						;AN000;
	pop	ds								;AN000;
	pop	dx								;AN000;
ok_ret_8:
	JMP	short ok_ret_7							;AN000;
 ELSE										;AN000;
	or	al, al			; AL = 0 (get table)?  ;AN000;
	jnz	okok					       ;AN000;
get_lbt:						       ;AN000;
