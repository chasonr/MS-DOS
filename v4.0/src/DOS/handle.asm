...
;
FreeJFN:
	InvokeFn pJFNFromHandle		;   d = pJFN (handle);
...
larger:
	...
	PUSH	BP
	InvokeFn $ALLOC			; allocate memory
	POP	BP
...
ASSUME DS:NOTHING
	...
	InvokeFn $DEALLOC		; deallocate old table meomory
...
;	PUSH	[SAVE_DI]		       ;AN000;;FT. save XA list
	...
	InvokeFn GetSet_XA		       ;AN000;;FT. issue Get/Set XA
...
gsdt:
	...
	STI
	InvokeFn Get_user_stack		; obtain place to return it
...
Procedure   $DUP,NEAR
	...
	InvokeFn JFNFree 		; free handle? into ES:DI, new in BX
DupErrorCheck:
	JC	DupErr			; nope, bye
	...
	InvokeFn DOS_Dup_Direct
	InvokeFn pJFNFromHandle		; get pointer
...
Procedure   $Dup2,NEAR
	...
	InvokeFn $Close			; close destination handle
