...
;	 push	 es					  ;AN000;
;	 InvokeFn FIND_DPB	 ; ds:si -> DPB 	  ;AN000;
;	 mov	 bp,si					  ;AN000;
;	 push	 ds					  ;AN000;
...
;
;	 InvokeFn DSKREAD	 ; else do absolute read		  ;AN000;
;	 jmp	 dos_exit	 ; then return				  ;AN000;

;Dos_Chk_Ah3:								   ;AN000;
;	 InvokeFn DSKWRITE	 ; do absolute write			  ;AN000;
;	 jmp	 dos_exit	 ; then exit				  ;AN000;
...
str_cmp:								  ;AN000;
	 ...
	 cmp	 ah,36					    ;AN000;
	 jne	 str_cpy				    ;AN000;
	 InvokeFn strcmp 	 ; string compare	    ;AN000;
	 jmp	 SHORT dos_exit 					  ;AN000;
str_cpy:								  ;AN000;
	 cmp	 ah,37					    ;AN000;
	 jne	 dos_error				    ;AN000;
	 InvokeFn strcpy 	 ; string copy		    ;AN000;
	 jmp	 SHORT dos_exit 					  ;AN000;
...
;	 InvokeFn FIND_DPB		 ; get DPB from drive number	   ;AN000;
...
PROCEDURE  GET_DOS_INFO,NEAR						   ;AN000;
	...
	InvokeFn ReadTime		; get time in CX:DX		   ;AN000;
...
;	InvokeFn $getExtCntry		; get country info		   ;AN000;
