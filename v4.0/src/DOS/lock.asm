...
;	JA	lock_bad_func		;MS. no,				;AN000;
	...
	InvokeFn SFFromHandle		       ; ES:DI -> SFT
...
;	InvokeFn Align_Buffer		;AN000;;MS. align ds:dx and set DMAADD
...
;	InvokeFn OWN_SHARE			;AN000;;MS. IFS owns share ?
...
;	InvokeFn $READ				;AN000;;MS. do read
;	JC	lockerror			;AN000;;MS. error
;lockend:					;AN000;
...
;	InvokeFn $WRITE				;AN000;;MS. do write
...
; DS, ES, DI, CX preserved, others destroyed
	...
	POP	DS
	CMP	AL,1
	jz	short ret_l_1	; 1 = retry, carry clear
	STC
	return
