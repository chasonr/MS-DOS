...
;; DOS 4.00 10/27/86
	...
	InvokeFn FastSeek_Open			   ; call fastseek		;AN000;
no_fastseek:
...
procedure SHARE_ERROR,NEAR
	...
	JNE	NO_HARD_ERR
HARD_ERR:
	InvokeFn SHARE_VIOLATION
	jnc	short ret_l_1		; User wants retry
NO_HARD_ERR:
...
OpenShareRetry:
	...
	InvokeFn SHARE_CHECK		; Final Check
...
;	InvokeFn NET_I24_ENTRY				 ;FT. issue int 24H	;AN000;
;	POP	DS					 ;FT.			;AN000;
;	return						 ;FT.			;AN000;
