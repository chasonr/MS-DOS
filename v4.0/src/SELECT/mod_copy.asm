...
; Restore the original status of APPEND if active.
    ...
    jc endif_l_3			;AN000; SAR
	 cmp NOT_FOUND_FLAG,1		;AN000; SAR
	 jne else_l_2
	       STC			;AN000; SAR
	  jmp short endif_l_2
	  else_l_2: 			;AN000; SAR
...
GET_SOURCE	PROC	NEAR;AN000;
	...
	repeat_l_1:     ;AN000;
	   ...
	   cmp SOURCE_PANEL,SUB_REM_DOS_A			;AN000;
	   jne else_l_6
...
LDF_SEE_IF_DONE:	     ;AN000;
    ...
    cmp FILE_NUM,DX				 ;AN000; Search while there are still more files
    ja @F
