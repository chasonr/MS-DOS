...
CHECK_VERSION:							;AN000;
	...
	SCAN_PARAMETERS  N_SELECT_MODE				;AN000;
		...
		cmp N_SELECT_MODE,E_SELECT_INV			;AN000;JW
		jne @F
		   DISPLAY_MESSAGE	6			;AN000;JW
		   GOTO_ 		EXIT_SELECT2		;AN000;JW
		@@:						;AN000;JW
								;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
...
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
     cmp N_SELECT_MODE,E_SELECT_FDISK				;AN000;JW
     jne @F
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	CHECK_DISPLAY						;AN000; determine display type
		cmp ACTIVE,EGA					;AN000;
		je @F
		cmp ALTERNATE,EGA				;AN000;
		je @F
		cmp ACTIVE,LCD					;AN000;
		je @F
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	jc else_l_3						;AN000;
	   ...
	   jc else_l_2	 					;AN000;check if error condition occurred
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ;;;	CALL	CURSOROFF					;AN000;
								;
	cmp ACTIVE,EGA						;AN000; if active display = EGA
	jne elseif_l_4
	   COPY_STRING		S_STR120_1,M_STR120_1,S_PREP_EGA;AN000;    set parameter for EGA.CPI
	jmp endif_l_4
	elseif_l_4:
	cmp ACTIVE,LCD						;AN000; elseif active display = LCD
	jne else_l_4
	...
	endif_l_4:						;AN000;
								;
	cmp S_STR120_1,0	 				;AN000; if parameter is not null
	jle @F
	...
	cmp N_SELECT_MODE,E_SELECT_FDISK	 		;AN000;
	jne @F
	   INIT_VAR		I_DEST_DRIVE, E_DEST_DRIVE_C	;AN000;
	   GOTO_ 		DATE_TIME_SCREEN		;AN000;
	@@:							;AN000;
								;
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	cmp N_KYBD_ALT,E_KYBD_ALT_YES				;AN000;
	jne else_l_7
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
	...
	INIT_VAR		I_CTY_KYBD, E_CTY_KB_PREDEF	;AN000; set country support=pre-defined support
								;
	cmp ACTIVE,CGA						;AN000; if CGA adaptor
	je @F
	cmp ALTERNATE,CGA					;AN000;
	jne else_l_11
	@@:
	   INIT_VAR		F_GRAFTABL, E_GRAFTABL_YES	;AN000;    set GRAFTABL = yes
	jmp short endif_l_11
	else_l_11:						;AN000; else
...
WELCOME_SCREEN2:						;AN000;
	...
	cmp N_USER_FUNC,E_F3					;AN000;DT if user entered F3 key
	jne elseif_l_13
	    GOTO_	     EXIT_DOS				;AN000;DT
	jmp endif_l_13
	elseif_l_13:
	...
	jne else_l_13
	   ...
	   @@:							;AN000;JW
	   GOTO_ 		INTRO_SCREEN			;AN000;    go to next screen
	jmp short endif_l_13
	else_l_13:						;AN000; else
	   CALL 		HANDLE_F3			;AN001;GHG exit to DOS command line
	   jnc else_l_12					;AN001;GHG
	       GOTO_		EXIT_DOS			;AN001;GHG
	   jmp short endif_l_12
	   else_l_12:						;AN001;GHG
	       GOTO_		WELCOME_SCREEN2 		;AN001;GHG
	   endif_l_12:						;AN000;
	endif_l_13:						;AN000;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
...
INTRO_SCREEN:							;AN000;
	...
	DISPLAY_PANEL						;AN000; display INTRODUCTION panel
								;
	GET_FUNCTION		FK_ENT_ESC_F3			;AN000; get user entered function
	cmp N_USER_FUNC,E_F3					;AN027;SEH  Added to prevent going to Welcome Screen
	jne elseif_l_14
	...
	cmp N_USER_FUNC,E_ENTER					;AN000; if user entered ENTER key
	jne else_l_14
	   GOTO_ 		WORKSPACE_SCREEN		;AN000;    go to next screen
	jmp short endif_l_14
	else_l_14:						;AN000; else
	   GOTO_ 		WELCOME_SCREEN2 		;AN001;GHG;    exit to DOS command line
	endif_l_14:						;AN000;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;
...
SCAN_INFO_CALL	PROC	NEAR					;AN000;
	SCAN_INFO_FILE	 F_SHELL, N_FORMAT_MODE,N_DISK1_MODE,I_DESTINATION,S_INSTALL_PATH,S_SELECT_TMP,P_STR120_1,M_STR120_1
		...
		;;;S_SELECT_TMP -  file for FDISK parameters	;
								;
		cmp N_SELECT_MODE,E_SELECT_INV			;AN000; if SELECT mode not MENU or FDISK
		jne @F
		  DISPLAY_MESSAGE	6			;AN000;
		  GOTO_			EXIT_DOS_CONT		;AN000;
		@@:						;AN000;    EXIT
								;
	       cmp N_SELECT_MODE,E_SELECT_FDISK			;AN000; if SELECT mode is FDISK
	       jne endif_l_15
	       cmp N_FORMAT_MODE,E_SELECT_INV 			;AN000; and format and disk status
	       je @F
	       cmp N_DISK1_MODE,E_SELECT_INV			;AN000; not available from SELECT.TMP
	       jne endif_l_15
	       @@:
		  DISPLAY_MESSAGE	6			;AN000;
		  GOTO_			EXIT_DOS_CONT		;AN000;
	       endif_l_15:					;AN000;     EXIT
	       RET						;AN000;
